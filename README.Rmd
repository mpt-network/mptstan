...
Because `mptstan` is based on `brms` and therefore `Stan`, you will need a C++ compiler to use the package. Installation instructions for a C++ compiler for your operationg system can be found here: https://github.com/stan-dev/rstan/wiki/RStan-Getting-Started
